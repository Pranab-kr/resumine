    ...
    <main className="min-h-screen pt-10">
      ...
      <section className="main-section">
        <div className="page-heading py-16">
          <h1 className="max-sm:text-4xl text-6xl leading-tight font-semibold">
        ...
        {!isLoading && auth.isAuthenticated && resumes?.length === 0 && (
          ...
          >
            <Link href="/upload">
              <HoverBorderGradient className="text-xl flex items-center font-semibold px-4 py-2 sm:px-8 sm:py-4 rounded-full">
        ...
        {!auth.isAuthenticated && puterReady && !puterLoading && (
          ...
          >
            ...
            >
              <Link href="/auth?next=/">
                <HoverBorderGradient className="text-xl flex items-center font-semibold px-4 py-2 sm:px-8 sm:py-2 rounded-full">
